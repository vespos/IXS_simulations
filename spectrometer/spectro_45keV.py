...
mL = LMultilayer(tLayer=mC, tThickness=30, bLayer=mNi, bThickness=30,
                 nPairs=100, substrate=mSi, p=p, E0=E0)
...
xtal2_pitch -= radians(0.0475) # manually optimised if energy is off
...
#                plot.xaxis.limits = [-20000, 20000]
        ...
        if od in ['S3','S4']:
            ...
            plot.caxis.limits = [E0-0.04,E0+0.04]
